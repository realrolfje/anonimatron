...
public class CommandLine {
	...
	public static final String OPT_JDBCURL = "jdbcurl";
	public static final String OPT_USERID = "userid";
	public static final String OPT_PASSWORD = "password";
	public static final String OPT_CONFIGFILE = "config";
	public static final String OPT_SYNONYMFILE = "synonyms";
	public static final String OPT_DRYRUN = "dryrun";
	public static final String OPT_CONFIGEXAMPLE = "configexample";
